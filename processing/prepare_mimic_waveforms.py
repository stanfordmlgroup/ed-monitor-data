...
"""
Script to prepare the MIMIC waveforms.

Example: python prepare_mimic_waveforms.py -i /deep/group/mimic3wdb-matched/physionet.org/files/mimic3wdb-matched/1.0/RECORDS-waveforms -o /deep/group/mimic3wdb-matched/processed -l 15 -w II
"""
